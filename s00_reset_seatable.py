    ...
    for k,v in add_dict.items():
        ...
        if k=='cos_delete':
            mt.base.add_column_options(f, k, [
                    {"name": "true", "color": "#EE30A7", "textColor": "#000000"},
                    {"name": "false", "color": "#C1FFC1", "textColor": "#000000"},
            ])

#################################################################### 删除数据


rows = mt.base.list_rows('cos', view_name=None, order_by=None, desc=False, start=None, limit=None)
